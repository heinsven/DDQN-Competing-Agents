...
Other than than running the notebook (Tennis.ipynb) which is fully doumented, I include for your convenience a `Report.pdf` file which contains the detailed instructions about how I approached this problem, leaving out the code and all complexities.
